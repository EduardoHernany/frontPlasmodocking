...
const alertStyles = {
  ...
  success: {
    container: "flex items-cgreener p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400",
    icon: "text-green-500",
...
export default function Alert({ type, message }) {
  ...
  if (!styles || closed) {
    return null; // Retorna null se o tipo não for válido ou se o alerta estiver fechado
  }
